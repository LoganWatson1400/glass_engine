...
class Renderer {
  ...
  public:
	/// @brief Initialise the renderer. Must be called after a GL context
	/// exists.
	bool init();
	...
	/// @brief Draw all visible MeshInstances in the scene from the camera's
	/// view.
	/// @param scene    The scene tree to walk.
	/// @param camera   The camera to render from.
	/// @param width    Viewport width in pixels.
	/// @param height   Viewport height in pixels.
	void draw(const SceneTree &scene, const Camera &camera, int width,
			  int height);
